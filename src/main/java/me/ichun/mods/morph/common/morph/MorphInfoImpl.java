...
public class MorphInfoImpl implements MorphInfo {
    ...
    private int transitionTicks, transitionTime;
    public MorphInfoImpl(Player player) { this.current = new MorphState(MorphVariant.createPlayerMorph(player.getUUID(), true)); }
